  ...
  getTaxCertificateRegistrationURL: {
    ...
    async run(context, runner) {
      ...
      await runner.run(
        'getTaxCertificateRegistrationURL',
        input,
        () => context.service.getTaxCertificateRegistrationURL(input),
        summarizeAccessUrl
      )
    },
  },
  ...
  getTaxCertificateExpirationDate: {
    ...
    async run(context, runner) {
      ...
      await runner.run(
        'getTaxCertificateExpirationDate',
        input,
        () => context.service.getTaxCertificateExpirationDate(input),
  ...
  checkTaxCertificateValidation: {
    ...
    async run(context, runner) {
      ...
      await runner.run(
        'checkTaxCertificateValidation',
        input,
        () => context.service.checkTaxCertificateValidation(input),
  ...
  getTaxCertificateInfo: {
    ...
    async run(context, runner) {
      ...
      await runner.run(
        'getTaxCertificateInfo',
        input,
        () => context.service.getTaxCertificateInfo(input),
        summarizeGenericObject
      )
    },
  },
