...
const SERVICE_NAME = 'HTCashbillService'

export function createHTCashbillService(_config: CompatConfig): CallbackService {
  return createCallbackServiceStub(SERVICE_NAME)
}

export function createHTCashbillPromiseService(_config: CompatConfig): PromiseService {
