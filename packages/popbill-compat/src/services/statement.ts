...
const SERVICE_NAME = 'StatementService'

export function createStatementService(_config: CompatConfig): CallbackService {
  return createCallbackServiceStub(SERVICE_NAME)
}

export function createStatementPromiseService(_config: CompatConfig): PromiseService {
