 ...
 */
export interface TaxInvoiceGetMassPrintUrlApiRequest {
  /**
   * 팝빌회원 사업자번호.
   *
   * `-` 없이 입력한다.
  ...
  path: TaxInvoiceGetMassPrintUrlApiRequestPath

  query: TaxInvoiceGetMassPrintUrlApiRequestQuery

  body: TaxInvoiceGetMassPrintUrlApiRequestBody
}
