 ...
 */
export interface TaxInvoiceRegistIssueApiRequest {
  /**
   * 팝빌회원 사업자번호.
   *
   * `-` 없이 입력한다.
  ...
  path?: TaxInvoiceRegistIssueApiRequestPath

  query?: TaxInvoiceRegistIssueApiRequestQuery

  body: TaxInvoiceRegistIssueApiRequestBody
}
